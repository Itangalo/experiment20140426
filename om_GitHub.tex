...
\item Om du inte är behörig att redigera i projektet kommer det att skapas en \textit{klon} av projektet, som du får redigera.
...
(Detta kallas på Git-språk att göra en \textit{merge}.)
